...
RUN wget -qO twitter-text-parse-go.tar.gz https://github.com/myl7/twitter-text-parse-go/archive/4ef36e65e0b6ad532d8aa77413453310659f141d.tar.gz
...
RUN wget -qO twitter-text-parse-go/lib/libtwitter_text_parse_go.a https://github.com/myl7/twitter-text-parse-go/releases/download/prebuilt/libtwitter_text_parse_go-x86_64-unknown-linux-musl.a
